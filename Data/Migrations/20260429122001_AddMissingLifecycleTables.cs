...
{
    /// <inheritdoc />
    public partial class AddMissingLifecycleTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // ── StepOutSteps: add ParentStepId + DurationHours ─────────────
            ...
            // ── FcoDocuments: add LinkedWorkOrderId ────────────────────────
            migrationBuilder.AddColumn<int>(
            ...
            migrationBuilder.CreateIndex(name: "IX_Milestones_ProjectId", table: "Milestones", column: "ProjectId");
            migrationBuilder.CreateIndex(name: "IX_Milestones_PhaseId", table: "Milestones", column: "PhaseId");
            migrationBuilder.CreateIndex(name: "IX_Milestones_TaskId", table: "Milestones", column: "TaskId");
